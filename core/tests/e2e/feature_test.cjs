...
(async () => {
    ...
    try {
        ...
        await page.screenshot({ path: 'tests/e2e/screenshots/01_login_page.png' });
        ...
        await page.screenshot({ path: 'tests/e2e/screenshots/03_sidebar.png' });

        // --- 3. Test Orders Page ---
        console.log('\n========== 3. TESTING ORDERS PAGE ==========\n');
        await page.goto(`${baseUrl}/user/orders`);
        await page.waitForLoadState('networkidle');
        await page.screenshot({ path: 'tests/e2e/screenshots/04_orders_page.png' });
        ...
        await page.waitForLoadState('networkidle');
        await page.screenshot({ path: 'tests/e2e/screenshots/05_payment_config.png' });
        ...
        await page.waitForLoadState('networkidle');
        await page.screenshot({ path: 'tests/e2e/screenshots/06_inbox_page.png' });
        ...
        await page.waitForLoadState('networkidle');
        await page.screenshot({ path: 'tests/e2e/screenshots/07_dialogflow_page.png' });
        ...
        await page.waitForLoadState('networkidle');
        await page.screenshot({ path: 'tests/e2e/screenshots/08_meta_ads_page.png' });
        ...
        await page.waitForLoadState('networkidle');
        await page.screenshot({ path: 'tests/e2e/screenshots/09_whatsapp_accounts.png' });

        const settingLink = await page.$('a:has-text("Setting")');
        if (settingLink) {
            await settingLink.click();
            await page.waitForLoadState('networkidle');
            await page.screenshot({ path: 'tests/e2e/screenshots/10_whatsapp_account_settings.png' });
