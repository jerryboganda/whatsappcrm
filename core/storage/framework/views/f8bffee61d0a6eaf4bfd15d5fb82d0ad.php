        ...
        <div class="floater-nav-bottom">
            <div class="floater-popup-whatsapp">
                <div class="floater-content-whatsapp-top">
                    <div class="floater-header-top-wrapper" style="background-color: #<?php echo e($floater->color_code); ?>">
                        <p><?php echo app('translator')->get('Welcome'); ?></p>
                ...
                <div class="floater-body-wrap">
                    <p class="floater-p-tag"><?php echo app('translator')->get('Hello! How may we assist you?'); ?></p>
                    <div class="floater-content-whatsapp-bottom">
                        ...
                        <button class="floater-send-msPopup" id="send-btn" type="button"
                            data-mobile="<?php echo e($floater->dial_code); ?><?php echo e($floater->mobile); ?>"
                            data-message="<?php echo e($floater->message); ?>">
                            <i style="color: #<?php echo e($floater->color_code); ?>"
            ...
            <button type="button" id="whats-openPopup" class="floater-whatsapp-button"
                style="background-color: #<?php echo e($floater->color_code); ?>">
...
<?php /**PATH /var/www/html/core/resources/views/templates/basic/user/floater/floater_preview.blade.php ENDPATH**/ ?>