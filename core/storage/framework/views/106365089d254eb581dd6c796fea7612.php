...
<?php $__env->startSection('content'); ?>
    <div class="chatbox-area">
        <?php echo $__env->make('Template::user.inbox.conversation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <div class="chatbox-area__body <?php if(!$selectedConversationId): ?> d-none <?php endif; ?>">
            <?php echo $__env->make('Template::user.inbox.message_box', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('Template::user.inbox.contact', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div class="empty-conversation <?php if($selectedConversationId): ?> d-none <?php endif; ?>">
            <img class="conversation-empty-image" src="<?php echo e(asset($activeTemplateTrue . 'images/conversation_empty.png')); ?>"
                alt="img">
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div class="modal-header__left">
                        <h5 class="modal-title"><?php echo app('translator')->get('Send Message Template'); ?></h5>
                        <p class="modal-subtitle"><?php echo app('translator')->get('Choose a message template to send to your contacts.'); ?></p>
                    </div>
                    <div class="modal-header__right">
                        <div class="btn--group">
                            <button class="btn--white btn" data-bs-dismiss="modal"
                                aria-label="Close"><?php echo app('translator')->get('Cancel'); ?></button>
                ...
                <div class="modal-body">
                    <div class="csv-form-wrapper">
                        <div class="csv-form-wrapper__left">
                            <form action="<?php echo e(route('user.inbox.message.template.send')); ?>" method="POST" id="template-form">
                                <?php echo csrf_field(); ?>
                                <div class="thumb-form-wrapper">
                                    <div class="form-group">
                                        <label class="label-two"><?php echo app('translator')->get('Template'); ?></label>
                                        <select class="form--control select2" name="template_id"
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($template->id); ?>"
                                                    data-template-header="<?php echo e(json_encode($template->header)); ?>"
                                                    data-cards="<?php echo e($template->cards); ?>"
                                                    data-template-body="<?php echo e($template->body); ?>"
                                                    data-template-footer="<?php echo e($template->footer); ?>"
                                                    data-header-format="<?php echo e($template->header_format); ?>"
                                                    data-buttons="<?php echo e(json_encode($template->buttons)); ?>"
                                                    data-header-media="<?php echo e(asset(getFilePath('templateHeader')) . '/' . $template->header_media); ?>">
                                                    <?php echo e(__($template->name)); ?>

                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <option value=""><?php echo app('translator')->get('No template found'); ?></option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-12">
                                            <div class="auth-devider text-center">
                                                <span> <?php echo app('translator')->get('HEADER VARIABLES'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 body-variable-area d-none">
                                    <div class="row justify-content-center">
                                        <div class="col-12">
                                            <div class="auth-devider text-center">
                                                <span> <?php echo app('translator')->get('BODY VARIABLES'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 d-none variable-code-wrapper">
                                    <?php $__currentLoopData = variableShortCodes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="btn btn--sm btn--dark code-btn"
                                            data-code="<?php echo e($value); ?>"><?php echo e($value); ?></span>
                                ...
                                <div class="preview-item__content">
                                    ...
                                    <div class="card-item">
                                        ...
                                        <div class="card-item__content">
                                            <p class="card-item__title header_text"><?php echo app('translator')->get('Template header'); ?></p>
    ...
    <div class="modal custom--modal fade locationModal progressModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div class="modal-header__left">
                        <h5 class="modal-title"><?php echo app('translator')->get('Send Location Message'); ?></h5>
                        <p class="modal-subtitle"><?php echo app('translator')->get('Select location via google map or enter latitude and longitude.'); ?>
                        </p>
                    </div>
                    <div class="modal-header__right">
                        <div class="btn--group">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('user.inbox.message.send')); ?>" method="POST" id="location-form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Latitude'); ?></label>
                                    <input type="text" class="form--control form-two" name="latitude"
                                        placeholder="<?php echo app('translator')->get('Ex:35.74186524893564'); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Longitude'); ?></label>
                                    <input type="text" class="form--control form-two" name="longitude"
                                        placeholder="<?php echo app('translator')->get('EX:-139.2120532811909'); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form--control form-two" name="name"
                                        placeholder="<?php echo app('translator')->get('Ex:Company 12, New York'); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Address'); ?></label>
                                    <input type="text" class="form--control form-two" name="address"
                                        placeholder="<?php echo app('translator')->get('EX:Street 12, Delta, New York, United States'); ?>">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Select Location via MAP'); ?></label>
                                    <input class="controls" id="searchBox" type="text" placeholder="<?php echo app('translator')->get('Search Here'); ?>">
                                    <div class="google-map" <?php if(gs('google_maps_api')): ?> style="height: 400px" <?php endif; ?>
                                        id="map"></div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal custom--modal fade paymentModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo app('translator')->get('Request Payment Link'); ?></h5>
                ...
                <div class="modal-body">
                    <form id="payment-link-form">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Gateway'); ?></label>
                                    <select class="form--control" name="gateway" required>
                                        <option value="stripe"><?php echo app('translator')->get('Stripe'); ?></option>
                                        <option value="razorpay"><?php echo app('translator')->get('Razorpay'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Amount'); ?></label>
                                    <input type="number" step="0.01" class="form--control" name="amount" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Currency'); ?></label>
                                    <input type="text" class="form--control" name="currency" value="USD" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="label-two"><?php echo app('translator')->get('Description'); ?></label>
                            ...
                            <div class="col-12 text-end mt-3">
                                ...
                                <button type="submit" class="btn btn--base"><?php echo app('translator')->get('Generate Link'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header p-2">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="modal-title"><?php echo app('translator')->get('Message Preview'); ?></h5>
                    </div>
                </div>
...
<?php $__env->startPush('script-lib'); ?>
    <script src="<?php echo e(asset($activeTemplateTrue . 'js/emoji-mart.min.js')); ?>"></script>
    <script src="<?php echo e(asset($activeTemplateTrue . 'js/pusher.min.js')); ?>"></script>
    <script src="<?php echo e(asset($activeTemplateTrue . 'js/broadcasting.js')); ?>"></script>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(gs('google_maps_api')); ?>&libraries=drawing,places,marker&v=3.45.8">
        </script>
<?php $__env->stopPush(); ?>
...
<?php $__env->startPush('script'); ?>
    <script>
        (function ($) {
            ...
            handleFormSubmit($messageForm, "<?php echo e(route('user.inbox.message.send')); ?>");
            handleFormSubmit($locationForm, "<?php echo e(route('user.inbox.message.send')); ?>");
            ...
            $paymentForm.on('submit', function (e) {
                ...
                $submitBtn.prop('disabled', true).text('<?php echo app('translator')->get("Generating..."); ?>');

                $.ajax({
                    url: "<?php echo e(route('user.payment.generate.link')); ?>",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response.success) {
                            ...
                            notify('success', "<?php echo app('translator')->get('Payment link generated and added to message box'); ?>");
                        } else {
                            notify('error', response.error || "<?php echo app('translator')->get('Something went to wrong'); ?>");
                        }
                    },
                    error: function (xhr) {
                        let errorMsg = "<?php echo app('translator')->get('Something went to wrong'); ?>";
                    ...
                    complete: function () {
                        $submitBtn.prop('disabled', false).text("<?php echo app('translator')->get('Generate Link'); ?>");
                    }
                });
            });
            ...
            $(document).on('click', '.resender', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('user.inbox.message.resend')); ?>",
                    type: "POST",
                    data: {
                    ...
                    error: function () {
                        notify('error', "<?php echo app('translator')->get('Something went wrong.'); ?>");
                    }
                }).always(function () {
                    isSubmitting = false;
            ...
            $messageInput.on("focus", function () {
                ...
                let route = "<?php echo e(route('user.inbox.message.status', ':id')); ?>";
                $.ajax({
            ...
            pusherConnection('receive-message', "<?php echo e($whatsappAccount->id); ?>");
            ...
            const mapKey = "<?php echo e(gs('google_maps_api')); ?>"; // TODO:: need to replace code with previous version

            $('.location-modal-btn').on('click', function () {
                if (!mapKey || mapKey == "") {
                    $('.preview-item__content').html(
                        `<div class="empty-preview"><h6 class="empty-preview__title"><?php echo app('translator')->get('Google Maps preview is currently unavailable.'); ?></h6></div>`
                    );
                } else {
                    initMap();
                }
            ...
            $(document).on('click', '.ai-response-button', function (e) {
                ...
                if (isSubmitting) return;
                isSubmitting = true;
                $messageInput.attr('readonly', true).attr("placeholder", "<?php echo app('translator')->get('Generating response from AI...'); ?>");

                $.ajax({
                    url: "<?php echo e(route('user.inbox.message.generate')); ?>",
                    type: "POST",
                    data: {
                        message: $message,
                        _token: "<?php echo e(csrf_token()); ?>"
                    ...
                    complete: function () {
                        ...
                        $messageInput.attr('readonly', false).attr('placeholder',
                            '<?php echo app('translator')->get('Type your message here message...'); ?>');
                    }
                });
            });
            ...
            $(document).on('click', '.ai-translate-button', function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('user.inbox.message.translate')); ?>",
                    type: "POST",
                    data: {
                        message: $message,
                        _token: "<?php echo e(csrf_token()); ?>"
            ...
            function showTemplatePreview() {
                ...
                const templateBody = $selected.data('template-body') ?? "<?php echo app('translator')->get('Template body'); ?>";
            ...
            function templateCardHtml(card, index) {
                ...
                const basePath = "<?php echo e(asset('assets/images/template_card_header')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/core/resources/views/templates/basic/user/inbox/list.blade.php ENDPATH**/ ?>