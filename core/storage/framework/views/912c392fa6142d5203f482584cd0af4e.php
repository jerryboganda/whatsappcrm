...
<head>
    ...
    <title> <?php echo e(gs()->siteName($exception->getStatusCode())); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/error/css/main.css')); ?>">
</head>
...
<body>
    <div class="error-content flex-center flex-column">
        ...
        <span class="error-content__text"><?php echo e($exception->getStatusCode()); ?></span>
        <?php echo $__env->yieldContent('content'); ?>
    </div>
</body>

</html>
<?php /**PATH C:\laragon\www\whatsapp_crm\core\resources\views/errors/app.blade.php ENDPATH**/ ?>