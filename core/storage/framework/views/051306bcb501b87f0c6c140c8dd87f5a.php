<?php if (\Illuminate\Support\Facades\Blade::check('gs', 'secure_password')): ?>
    <div class="strong-password">
        <h6 class="title password-message"><?php echo app('translator')->get('Password'); ?></h6>
        ...
        <ul class="list">
            <li class="item first-validation"><i class="las la-check-circle"></i> <?php echo app('translator')->get('Minimum 6 characters'); ?></li>
            <li class="item second-validation"><i class="las la-check-circle"></i> <?php echo app('translator')->get('Uppercase and lowercase'); ?></li>
            <li class="item third-validation"><i class="las la-check-circle"></i> <?php echo app('translator')->get('At least one number'); ?></li>
            <li class="item fourth-validation"><i class="las la-check-circle"></i> <?php echo app('translator')->get('At least one symbol'); ?></li>
        </ul>
    </div>
                ...
                function strongPasswordChecker() {
                    ...
                    if (password.length >= 4) {
                        if (passwordStrength < 50) {
                            $(".password-message").text(`<?php echo app('translator')->get('Weak Password'); ?>`);
                            $(".progress-alert span").removeClass('bg-warning bg-danger').addClass('bg-danger');
                        } else if (passwordStrength < 75) {
                            $(".password-message").text(`<?php echo app('translator')->get('Good Password'); ?>`);
                            $(".progress-alert span").removeClass('bg-warning bg-danger').addClass('bg-warning');
                        } else {
                            $(".password-message").text(`<?php echo app('translator')->get('Strong Password'); ?>`);
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/core/resources/views/components/strong-password.blade.php ENDPATH**/ ?>