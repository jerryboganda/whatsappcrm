...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-container">
        <div class="report-wrapper">
            ...
            <?php if(($summary['pending_delivery'] ?? 0) > 0): ?>
                <div class="alert alert-info mt-3 mb-0">
                    <?php echo app('translator')->get('Live updates are enabled for this report while delivery is still in progress.'); ?>
                </div>
            <?php endif; ?>

            <?php if(($summary['pending_delivery'] ?? 0) > 0 && !($health['has_webhook_events'] ?? false)): ?>
                <div class="alert alert-warning mt-3 mb-0">
                    <?php echo app('translator')->get('API Accepted means Meta acknowledged the send request, not delivery confirmation. Webhook delivery receipts are still pending for this campaign.'); ?>
                    <?php if(($health['pending_without_webhook_minutes'] ?? 0) > 0): ?>
                        <span class="d-block"><?php echo app('translator')->get('Pending without webhook updates for'); ?>: <?php echo e($health['pending_without_webhook_minutes']); ?> <?php echo app('translator')->get('minutes'); ?></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
                ...
                <table class="table table--responsive--xl">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('Action Required'); ?></th>
                            <th><?php echo app('translator')->get('Count'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $failures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($failureAdvice); ?></td>
                                <td><?php echo e($failure->total); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="4" class="text-center"><?php echo app('translator')->get('No failure records found'); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = @$campaignContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaignContact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    ...
                                    ?>
                                    <?php if($contactErrorText): ?>
                                        <div class="text--danger fs-12"><?php echo e(\Illuminate\Support\Str::limit($contactErrorText, 260)); ?></div>
                                        <?php if($campaignContact->meta_error_code): ?>
                                            <div class="text--muted fs-11"><?php echo app('translator')->get('Code'); ?>: <?php echo e($campaignContact->meta_error_code); ?></div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </td>
...
<?php $__env->startPush('script'); ?>
    <script>
        (function($) {
            ...
            const pendingDelivery = Number(<?php echo json_encode((int) ($summary['pending_delivery'] ?? 0), 15, 512) ?>);
