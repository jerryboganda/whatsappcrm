    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="dashboard-body__top">
                <div class="left">
                    <p class="text"><?php echo app('translator')->get('Here’s your overview of your account.'); ?></p>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.permission_check','data' => ['permission' => ['add contact', 'add campaign']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['permission' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['add contact', 'add campaign'])]); ?>
                    <div class="right">
                        <?php if (isset($component)) { $__componentOriginala51f62547316d5db73491e0449589f36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala51f62547316d5db73491e0449589f36 = $attributes; } ?>
...
<?php $component->withAttributes(['permission' => 'add contact']); ?>
                            <a href="<?php echo e(route('user.contact.create')); ?>" class="btn btn--info btn-shadow">
                                <span class="btn-icon">
                                    <i class="fas fa-user"></i>
                                </span> <?php echo app('translator')->get('Add Contacts'); ?>
                            </a>
...
<?php $component->withAttributes(['permission' => 'add campaign']); ?>
                            <a href="<?php echo e(route('user.campaign.create')); ?>" class="btn btn--base btn-shadow">
                                ...
                                </span><?php echo app('translator')->get('Create Campaign'); ?>
                            </a>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala51f62547316d5db73491e0449589f36)): ?>
...
<?php endif; ?>
        ...
        <div class="alert alert--danger mb-3" role="alert">
            ...
            <div class="alert__content">
                <div class="flex-between mb-2 gap-2 align-items-start">
                    <h5 class="alert__title mb-0"><?php echo app('translator')->get('KYC Documents Rejected'); ?></h5>
                </div>
                <p class="mb-0">
                    <?php echo e(__(@$kyc->data_values->reject)); ?>

                    <a class="text--info" href="<?php echo e(route('user.kyc.form')); ?>"><?php echo app('translator')->get('Click Here to Re-submit Documents'); ?></a>,
                    <a class="text--info" href="<?php echo e(route('user.kyc.data')); ?>"><?php echo app('translator')->get('See KYC Data'); ?></a>,
                    <button type="button" class="text--danger" data-bs-toggle="modal"
                        data-bs-target="#kycRejectionReason"><?php echo app('translator')->get('Show Reject Reason'); ?>
                    </button>
                </p>
            </div>
        </div>
    <?php elseif(auth()->user()->kv == Status::KYC_UNVERIFIED): ?>
        <div class="alert alert--info mb-3" role="alert">
            ...
            <div class="alert__content">
                <h5 class="alert__title"><?php echo app('translator')->get('KYC Verification required'); ?></h5>
                <p class="mb-0">
                    <?php echo e(__(@$kyc->data_values->required)); ?>

                    <a href="<?php echo e(route('user.kyc.form')); ?>"><?php echo app('translator')->get('Click Here to Submit Documents'); ?></a>
                </p>
            </div>
        </div>
    <?php elseif(auth()->user()->kv == Status::KYC_PENDING): ?>
        <div class="alert alert--warning mb-3" role="alert">
            ...
            <div class="alert__content">
                <h4 class="alert__title"><?php echo app('translator')->get('KYC Verification pending'); ?></h4>
                <p class="mb-0">
    ...
    <div class="row gy-4">
        <?php if (isset($component)) { $__componentOriginala51f62547316d5db73491e0449589f36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala51f62547316d5db73491e0449589f36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.permission_check','data' => ['permission' => 'view wallet']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('permission_check'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'view wallet']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.transactions')); ?>" class="dashboard-widget widget-two widget-blue">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Wallet Balance'); ?></h6>
...
<?php $component->withAttributes(['permission' => 'view contact']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.contact.list')); ?>" class="dashboard-widget widget-two widget-blue">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Contact'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_contact']); ?>
...
<?php $component->withAttributes(['permission' => 'view contact tag']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.contacttag.list')); ?>" class="dashboard-widget widget-two widget-blue">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Contact Tag'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_tag']); ?>
...
<?php $component->withAttributes(['permission' => 'view contact list']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.contactlist.list')); ?>" class="dashboard-widget widget-two widget-blue">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Contact List'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_list']); ?>
...
<?php $component->withAttributes(['permission' => 'view campaign']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.campaign.index')); ?>" class="dashboard-widget widget-two widget-purple">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Campaign'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_campaign']); ?>
...
<?php $component->withAttributes(['permission' => 'view campaign']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.campaign.index')); ?>" class="dashboard-widget  widget-two widget-purple"
                    data-bs-toggle="tooltip" title="<?php echo app('translator')->get('Total Campaigns Message'); ?>">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Message'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_campaign_message']); ?>
            ...
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.campaign.index')); ?>" class="dashboard-widget  widget-two widget-purple"
                    data-bs-toggle="tooltip" title="<?php echo app('translator')->get('Success Campaign Message'); ?>">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Success Message'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_campaign_message_success']); ?>
            ...
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.contact.list')); ?>" class="dashboard-widget widget-two widget-purple"
                    data-bs-toggle="tooltip" title="<?php echo app('translator')->get('Failed Campaign Message'); ?>">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Failed Message'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_campaign_message_failed']); ?>
...
<?php $component->withAttributes(['permission' => 'view flow builder']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.flow.builder.index')); ?>" class="dashboard-widget widget-two widget-red">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Flow'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_flow']); ?>
...
<?php $component->withAttributes(['permission' => 'view shortlink']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.shortlink.index')); ?>" class="dashboard-widget widget-two widget-red">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total ShortLink'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_shortlink']); ?>
...
<?php $component->withAttributes(['permission' => 'view floater']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.floater.index')); ?>" class="dashboard-widget widget-two widget-red">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Floater'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(@$widget['total_floater']); ?>
...
<?php endif; ?>
        <?php if(isParentUser()): ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.deposit.history')); ?>" class="dashboard-widget widget-two widget-red">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Deposit'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(showAmount($widget['total_deposit_amount'])); ?>
            ...
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.withdraw.history')); ?>" class="dashboard-widget widget-two widget-green">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Withdraw'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e(showAmount($widget['total_withdraw_amount'])); ?>
            ...
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.referral.index')); ?>" class="dashboard-widget widget-two widget-green">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Refer User'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e($widget['total_referrer']); ?>
            ...
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.transactions')); ?>" class="dashboard-widget widget-two widget-green">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Total Transaction'); ?></h6>
                        <p class="dashboard-widget__number">
                            <?php echo e($widget['total_transaction']); ?>
        ...
        <?php if (isset($component)) { $__componentOriginala51f62547316d5db73491e0449589f36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala51f62547316d5db73491e0449589f36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.permission_check','data' => ['permission' => 'view subscription']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('permission_check'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'view subscription']); ?>
            <div class="col-xxl-3 col-sm-6">
                <a href="<?php echo e(route('user.subscription.index')); ?>" class="dashboard-widget widget-two widget-green">
                    <div class="dashboard-widget__icon-box">
                        <div class="dashboard-widget__icon flex-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="CurrentColor"
                                fill="none">
                    ...
                    <div class="dashboard-widget__content">
                        <h6 class="dashboard-widget__text"><?php echo app('translator')->get('Plan Status'); ?></h6>
                        <p class="dashboard-widget__number">
                            <span class="text">
                                <?php if(getParentUser()->plan): ?>
                                    <?php echo e(__(getParentUser()->plan->name)); ?>

                                    <?php if(now()->parse(getParentUser()->plan_expired_at)->isPast()): ?>
                                        - <span class="text--danger"><?php echo app('translator')->get('Expired'); ?></span>
                                    <?php endif; ?>
                                <?php else: ?>
        ...
        <?php if(isParentUser()): ?>
            <div class="col-lg-6">
                <div class="transaction-table-inner h-100 d-flex flex-column">
                    <h6><?php echo app('translator')->get('Latest Transaction'); ?></h6>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div>
                                                <?php echo e(showAmount($transaction->amount)); ?> + <span class="text--danger"
                                                    data-bs-toggle="tooltip"
                                                    title="<?php echo app('translator')->get('Processing Charge'); ?>"><?php echo e(showAmount($transaction->charge)); ?>

                                                </span>
                                                <br>
                                                <strong data-bs-toggle="tooltip" title="<?php echo app('translator')->get('Amount with charge'); ?>">
                                                    <?php echo e(showAmount($transaction->amount + $transaction->charge)); ?>
...
<?php $component->withAttributes(['permission' => 'view subscription']); ?>
            <div class="col-lg-6">
                <h6><?php echo app('translator')->get('Latest Contact'); ?></h6>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo e(__(auth()->user()->kyc_rejection_reason)); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\whatsapp_crm\core\resources\views/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>