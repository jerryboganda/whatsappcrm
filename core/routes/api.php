...
Route::namespace('Api')->name('api.')->group(function () {
    ...
    Route::namespace('Extension')
        ->prefix('extension/group-extraction')
        ->middleware('group.extract.signature')
        ->controller('GroupExtractionController')
        ->group(function () {
            Route::post('jobs', 'createJob');
            Route::post('jobs/{jobId}/chunks', 'appendChunk');
            Route::post('jobs/{jobId}/finalize', 'finalize');
        });
